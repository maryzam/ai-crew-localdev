...
| 4. Automate quality loops | Expand invariant tests, verify/retry flows, PR risk tiers, auto-review triggers, post-merge smoke checks, and revert-driven policy escalation. | Routine work advances with less human gating while high-risk changes still receive explicit review. |
