...
func TestPolicyEnforcerSetPolicy(t *testing.T) {
	...
	if err := e.AuthorizeResource("claude", api.ResourceURI{Provider: "github", Kind: "repo", Identifier: "owner/repo-c"}); err == nil {
	...
	if err := e.AuthorizeResource("claude", api.ResourceURI{Provider: "github", Kind: "repo", Identifier: "owner/repo-b"}); err == nil {
