...
func TestPolicyEnforcerAuthorizeResource(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			agent:    "claude",
			resource: api.ResourceURI{Provider: "github", Kind: "repo", Identifier: "owner/repo-a"},
		},
		{
			name:     "github repo not allowed",
			agent:    "claude",
			resource: api.ResourceURI{Provider: "github", Kind: "repo", Identifier: "owner/repo-x"},
			wantErr:  true,
		},
		{
			name:     "unknown agent",
		...
		},
		{
			...
			agent:       "claude",
			resource:    api.ResourceURI{Provider: "aws", Kind: "iam", Identifier: "arn:aws:iam::123:role/foo"},
			wantErr:     true,
			wantUnknown: true,
		},
		{
			...
			agent:    "claude",
			resource: api.ResourceURI{Provider: "github", Kind: "org", Identifier: "owner"},
			wantErr:  true,
		},
	}
