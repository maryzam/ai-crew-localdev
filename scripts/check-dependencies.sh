...
allow_internal_imports "./internal/agents/capabilities" "^${module}/internal/platform/paths$" "the agent capability registry may depend only on platform path constants"
